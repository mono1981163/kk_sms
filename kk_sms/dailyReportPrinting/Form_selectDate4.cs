...
{
    public partial class Form_selectDate4 : Form
    {
        public Form_selectDate4()
        {
            InitializeComponent();
        }

        private void Form_selectDate4_Load(object sender, EventArgs e)
        {
        ...
        private void button_ok_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (saveFileDialog_savePdf.ShowDialog() == DialogResult.OK)
                {
                    ...
                    var fileName = inidata["Pdf"]["path"] + "仕入先別仕入一覧表__" + date + ".pdf";
