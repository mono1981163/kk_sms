        ...
        private void button_ok_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (saveFileDialog_savePdf.ShowDialog() == DialogResult.OK)
                {
                    ...
                    string query = "SELECT orderno , syainno ,SUBSTRING(nyukoday,1,10) , hinmaei , toukyuname ,  kaikyuname , zaikosu , tanka , kingaku , syainname  FROM tbl_nyuko WHERE nyukoday='" + date + "'";
