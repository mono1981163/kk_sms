...
{
    public partial class payment_delete : Form
    {
        public payment_delete()
        {
            InitializeComponent();
        }
        private void button_delete_Click(object sender, EventArgs e)
        {
            ...
            string pay_no = rep_no.Text;
            bool flag = true;
            try
            {
                if (String.IsNullOrEmpty(pay_no))
                {
        ...
        private void payment_delete_Load(object sender, EventArgs e)
        {
        ...
        private void textBox_supplier_no_TextChanged(object sender, EventArgs e)
        {
            ...
            if (inputValue == "-")
            {
                var form_selectRep = new kk_sms.masterManagement.payment.rep_list(this);
            ...
            else
            {
                try
                {
                    ...
                    var mysqlConnection = new MySqlConnection(mysqlConf);
                    mysqlConnection.Open();
                    string query = "SELECT dainame FROM tbl_daibarai WHERE daino = " + inputValue;
                    MySqlCommand sqlCommand = new MySqlCommand(query, mysqlConnection);
