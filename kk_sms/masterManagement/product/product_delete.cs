...
namespace kk_sms.masterManagement.product
{
    public partial class product_delete : Form
    {
            ...
            try
            {
                ...
                if (flag)
                {
...

                    {
                        ...
                        string query = "DELETE FROM m_hinban WHERE hinban='" + product_no + "'";
        ...
        private void no_keypress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                var form_selectRep = new kk_sms.masterManagement.product.rep_list(this);
