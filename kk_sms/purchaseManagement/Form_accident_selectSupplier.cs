...
{
    public partial class Form_accident_selectSupplier : Form
    {
        private Form_accident parentForm;

        public Form_accident_selectSupplier(Form_accident parent)
        {
            InitializeComponent();
            parentForm = parent;
        }
        ...
        private void Form_selectRep_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = "SELECT COUNT(uid) FROM m_siire";
                ...
                query = "SELECT siireno, siirename FROM m_siire;";
        ...
        private void button_ok_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                parentForm.change_supplier(code, name);
                Close();
            }
            catch (Exception ex)
            {
