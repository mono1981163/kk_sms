...
{
    public partial class Form_accidentCorrectUser : Form
    {
        private Form_accidentCorrection parentForm;

        public Form_accidentCorrectUser(Form_accidentCorrection parent)
        {
            InitializeComponent();
            parentForm = parent;
        }

        private void Form_accidentCorrectUser_Load(object sender, EventArgs e)
        {
            try
            {
