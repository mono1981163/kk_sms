...
{
    public partial class Form_accidentGoods : Form
    {
        private Form_accidentInput parentForm;

        public Form_accidentGoods(Form_accidentInput parent)
        {
            InitializeComponent();
            parentForm = parent;
        }

        private void Form_accidentGoods_Load(object sender, EventArgs e)
        {
            try
            {
