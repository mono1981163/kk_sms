...
{
    public partial class Form_accidentGrade : Form
    {
        private Form_accidentInput parentForm;

        public Form_accidentGrade(Form_accidentInput parent)
        {
            InitializeComponent();
            parentForm = parent;
        }

        private void Form_accidentGrade_Load(object sender, EventArgs e)
        {
            try
            {
